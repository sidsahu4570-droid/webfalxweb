...
// Page SEO Metadata
$page_seo = [
    'title' => 'Complete 10-Page Website + 1 Month FREE Social Media | WebFalx Offer',
...
<style>
    /* Streamline header navigation on /offer */
...
<!-- ========================================================================= -->
<!-- 3. WHY TRUST WEBFALX (4 Benefits + 3 Mini Portfolio Screens) -->
<!-- ========================================================================= -->
...
<section id="lead-form" class="compact-section" style="scroll-margin-top: 60px;">
    <div class="container" style="max-width: 740px;">
        ...
        <div class="lead-form-box">
            ...
            <form action="<?php echo BASE_URL; ?>offer#lead-form" method="POST" style="display: flex; flex-direction: column; gap: 14px;">
                <?php echo csrf_field(); ?>
